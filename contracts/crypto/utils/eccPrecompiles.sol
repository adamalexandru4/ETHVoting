...
function ecmul(uint256 x, uint256 y, uint256 scalar) public returns(uint256[2] memory p) {
...
function ecadd(uint256 x1, uint256 y1, uint256 x2, uint256 y2) public returns (uint256[2] memory p) {

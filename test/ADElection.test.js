...
contract('ADElection', async accounts => {
    ...
    describe('Create vote and ZK-Snarks of vote', () => {
        ...
        it('Generate proof and register it on the smart-contract', async () => {
            ...
            // var A = [ web3.utils.toHex(proof.proof.pi_a[0].toString()), web3.utils.toHex(proof.proof.pi_a[1].toString()) ];
            // var A_p = [ web3.utils.toHex(proof.proof.pi_ap[0].toString()), web3.utils.toHex(proof.proof.pi_ap[1].toString()) ];
            // var B = [ [ web3.utils.toHex(proof.proof.pi_b[0][1].toString()), web3.utils.toHex(proof.proof.pi_b[0][0].toString()) ],
            //           [ web3.utils.toHex(proof.proof.pi_b[1][1].toString()), web3.utils.toHex(proof.proof.pi_b[1][0].toString()) ]];
            // var B_p = [ web3.utils.toHex(proof.proof.pi_bp[0].toString()), web3.utils.toHex(proof.proof.pi_bp[1].toString()) ];
            // var C = [ web3.utils.toHex(proof.proof.pi_c[0].toString()), web3.utils.toHex(proof.proof.pi_c[1].toString()) ];
            // var C_p = [ web3.utils.toHex(proof.proof.pi_cp[0].toString()), web3.utils.toHex(proof.proof.pi_cp[1].toString()) ];
            // var H = [ web3.utils.toHex(proof.proof.pi_h[0].toString()), web3.utils.toHex(proof.proof.pi_h[1].toString()) ];
            // var K_p = [ web3.utils.toHex(proof.proof.pi_kp[0].toString()), web3.utils.toHex(proof.proof.pi_kp[1].toString()) ];
